...
@section('title', 'Employee | Self | Projects | TakeOff On Progress')
@section('styles')
            ...
            <div class="row">
                <div class="col-md-8 col-sm-12">                        
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">{{ Auth::user()->full_name }} Self Activity Projects | TakeOff On Progress.</li>
                    </ul>
                </div>
