<tr>
        ...
        <small>
            <b>
                <a href="{{ route('projectShow.show', $project->id) }}"
                    ...
                    style="display: inline-block;line-height: 14px;text-transform:lowercase;">
    ...
    <td>
        ...
        <span data-toggle="modal"
              ...
              class="btnGetUrl"
              data-url="{{ url('/employee/project/' . urlencode($project->id)) }}">
        ...
        @else 
            <span data-toggle="modal" 
                ...
                <a href="javascript:void(0);" 
                   ...
                   <i class="fa fa-lock">
                      <sup><i class="fa fa-key" aria-hidden="true"></i></sup>
                   </i>           
                </a>
