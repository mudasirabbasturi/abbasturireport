...
<body class="theme-cyan">
    ...
    <div class="page-loader-wrapper">
        <div class="loader">
            <div class="m-t-30">
                {{-- <img src="{{ asset('report_logo.png') }}" alt="Report Admin." width="48"
                    height="48"> --}}
                <img src="{{ asset('ReportLogo.PNG') }}" alt="Report Employee Dashboard" width="350" height="100">
            </div>
            <p>Please wait...</p>
        </div>
    </div>
    ...
    <div id="wrapper">
        @include("dashboard.employee.header")
