                    ...
                    <tbody>
                        @foreach ($notifications as $notification)
                            <tr>
                                ...
                                <td>
                                    @if ($notification->notification_from)
                                ...
                                <td>
                                    @if ($notification->userNotification && $notification->userNotification->status == 0 && $notification->userNotification->user_id == $user->id)
                                        ...
                                        <form id="markread-form-{{ $notification->id }}" action="{{ route('notifications.update', ['notification' => $notification->id]) }}"
                                    ...
                                    <form id="delete-form-{{ $notification->id }}" action="{{ route('notifications.destroy', ['notification' => $notification->id]) }}"
                                        method="POST" style="display: none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>
