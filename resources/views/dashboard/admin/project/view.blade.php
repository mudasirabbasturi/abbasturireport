                        ...
                        <div class="row p-2">
                            ...
                            <div class="col-12 mb-2">
                                ...
                                <input type="text" class="form-control mb-2" 
                                       value="{{ $project->project_client_name }}"
                                       readonly>
                                ...
                                @else
                                <input type="text" class="form-control mb-2" 
                                       value="None Please Select Any if having notes."
                                       readonly>
                            ...
                            <div class="col-md-4 mb-2">
                                ...
                                <input type="number" 
                                        class="form-control" 
                                        name="project_deduction" 
                                        id="deduction" 
                                        value="{{ $project->project_deduction }}" 
                                        placeholder="Enter Percent in number if have"
                                        min="0">
                            </div>
                            <div class="col-md-4 mb-2">
                                ...
                                <input type="text" 
                                        class="form-control" 
                                        value="{{ $project->project_total_price }}" 
