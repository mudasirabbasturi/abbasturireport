        ...
        <tbody>
            <tr>
                <td style="padding-right:10px;padding-left:10px;" align="center" valign="top" id="bodyCell">
                    <table border="1" cellpadding="0" cellspacing="0" width="100%" class="wrapperWebview"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="padding-top: 20px; padding-bottom: 20px; padding-right: 0px;"
                                                    ...
                                                    <a href="#"
                                                        style="color:#1a1919;font-family:'Open Sans',Helvetica,Arial,sans-serif;font-weight:400;font-style:normal;letter-spacing:normal;line-height:20px;text-transform:none;text-align:center;text-decoration:none;padding:0;margin:0"
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="wrapperBody"
                        ...
                        <tbody>
                            <tr>
                                <td align="center" valign="top">
                                    <table border="1" cellpadding="1" cellspacing="1" width="100%" class="tableCard"
                                        style="background-color:#fff;border-color:#e5e5e5;border-style:solid;border-width:0 1px 1px 1px;">
                                        <tbody>
                                            <tr>
                                                <td style="background-color:#2F9588;font-size:1px;line-height:3px"
                                            ...
                                            <tr>
                                                <td style="padding-bottom: 0px; padding-left: 20px; padding-right: 20px;"
                                                    ...
                                                    <h4 class="text"
                                                        ...
                                                        The project status has been updated.</h4>
                                                </td>
                                            </tr>
                                            <tr>
                                                            ...
                                                            <tr>
                                                                <td style="padding-bottom: 10px; padding-top: 10px;" align="center"
                                                                    ...
                                                                    <p class="text"
                                                                        ...
                                                                        Status changed from "revision" to "pending"..
                                                                        Please click Project Link button to
                                                                        see the project.</p>
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                            ...
                                                            <tr>
                                                                <td style="padding-top:20px;padding-bottom:20px"
                                                                    ...
                                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td style="background-color: #2F9588; padding: 12px 35px; border-radius: 50px;"
